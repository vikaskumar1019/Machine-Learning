...
```{r}
# Looking at alpha and lambda
fold1.1_impute$bestTune # alpha = 0.6     & lambda = 0.005121988
fold1.2_impute$bestTune # alpha = 0.1     & lambda = 0.3396193
fold1.3_impute$bestTune # alpha = 1.0     & lambda = 0.002295346
fold1.4_impute$bestTune # alpha = 0.1     & lambda = 0.787331
fold1.5_impute$bestTune # alpha = 0.1     & lambda = 0.7829115

fold2.1_impute$bestTune # alpha = 0.6     & lambda = 0.01204634
fold2.2_impute$bestTune # alpha = 0.6     & lambda = 0.0009622643
fold2.3_impute$bestTune # alpha = 0.1     & lambda = 0.144025
fold2.4_impute$bestTune # alpha = 1.0     & lambda = 0.001888629
fold2.5_impute$bestTune # alpha = 0.1     & lambda = 0.1468633

fold3.1_impute$bestTune # alpha = 0.6     & lambda = 0.01145902
fold3.2_impute$bestTune # alpha = 0.1     & lambda = 0.3476288
fold3.3_impute$bestTune # alpha = 0.2     & lambda = 0.1497307
fold3.4_impute$bestTune # alpha = 0.1     & lambda = 0.06129043
fold3.5_impute$bestTune # alpha = 1.0     & lambda = 0.002254064

fold4.1_impute$bestTune # alpha = 0.2     & lambda = 0.1490291
fold4.2_impute$bestTune # alpha = 0.7     & lambda = 0.02847595
fold4.3_impute$bestTune # alpha = 1.0     & lambda = 0.0009747934
fold4.4_impute$bestTune # alpha = 0.2     & lambda = 0.06555736
fold4.5_impute$bestTune # alpha = 0.1     & lambda = 0.148803

fold5.1_impute$bestTune # alpha = 0.7     & lambda = 0.06479883
fold5.2_impute$bestTune # alpha = 0.1     & lambda = 0.3279409
fold5.3_impute$bestTune # alpha = 1.0     & lambda = 0.002238869
fold5.4_impute$bestTune # alpha = 0.1     & lambda = 0.06263406
fold5.5_impute$bestTune # alpha = 1.0     & lambda = 0.002286701
```
